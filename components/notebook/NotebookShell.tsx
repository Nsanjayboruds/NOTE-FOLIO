...
const WELCOME_BUBBLES = [
  "You've opened Nishant's journal. I'm NishantBot — handling the easy questions while he ships.",
...
const TOOL_FALLBACK_REPLY: Record<ToolName, string> = {
  ...
  showBlog: "Opening the blog.",
  showTechStack: "Showing the tech stack.",
};
