...
// Order matters — LinkedIn is Nishant's preferred first-contact channel, so
...
const FIELDS: ContactField[] = [
  {
    label: "linkedin",
    display: "/in/nishant-borude",
    href: "https://www.linkedin.com/in/nishant-borude-554293311",
    icon: <LinkedInIcon />,
  },
  {
    label: "github",
    display: "/nishant-borude",
    href: "https://github.com/Nsanjayboruds",
    icon: <GitHubIcon />,
  },
  {
    label: "twitter / x",
    display: "@nishant_borude",
    href: "https://x.com/borude_nis67705",
    icon: <XIcon />,
  },
  {
    label: "email",
    display: "nishantborude555@gmail.com",
...
export function ContactPage({
  ...
  const onCopyEmail = async (e: React.MouseEvent) => {
    ...
    try {
      await navigator.clipboard.writeText("contact@nishantborude.com");
      setCopied("email");
      e.preventDefault();
    } catch {
  ...
  return (
    ...
    <div style={{ position: "absolute", inset: 0 }}>
      ...
      >
        ...
        >
          <HandwrittenText text="— nishant" delayMs={SIGNATURE_DELAY} />
        </div>
      </div>
