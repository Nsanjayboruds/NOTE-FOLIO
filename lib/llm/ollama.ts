...
const OLLAMA_TOOLS = [
  {
    ...
    function: {
      name: "showAbout",
      description:
        "Display Nishant's personal About page. Call for open-ended 'tell me about yourself' / 'who are you' / 'what's your story' style questions, or when the user explicitly asks for /about.",
  ...
  },
  {
    ...
    function: {
      name: "showLinkedIn",
      description:
        "Display a stacked-deck carousel of Nishant's favorite LinkedIn posts. Call when the user asks about LinkedIn, posts, or public writing.",
      parameters: { type: "object", properties: {}, required: [] },
    },
  },
];
